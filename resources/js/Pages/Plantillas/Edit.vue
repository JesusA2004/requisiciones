<!-- resources/js/Pages/Plantillas/Edit.vue -->
...
const {
  ...
  showError,
  fieldError,
} = usePlantillaEdit(catalogos as any, plantilla, routes)
</script>
      ...
      <form class="space-y-6" @submit.prevent="update()">
        ...
        <div class="rounded-3xl border border-slate-200/70 dark:border-white/10 bg-white dark:bg-neutral-900 shadow-sm p-5 sm:p-6 space-y-4">
          <div class="flex items-center justify-between gap-3">
            ...
            <div v-if="saving" class="text-xs font-semibold text-slate-500 dark:text-neutral-400">
              Guardando...
            </div>
          </div>
            ...
            <div>
              ...
              <input
                ...
                class="mt-1 w-full rounded-2xl px-3 py-2 text-sm border bg-white
                       ...
                       dark:border-white/10 dark:bg-neutral-950/40 dark:text-neutral-100 transition"
          ...
          <div class="flex items-center justify-between gap-2">
            ...
            <button
              ...
              class="rounded-2xl px-4 py-2 text-sm font-semibold bg-emerald-600 text-white
                     hover:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 transition active:scale-[0.99]"
            >
              Agregar item
            </button>
          </div>
          ...
          <div v-if="items.length > 0" class="space-y-3">
            ...
            >
              <div class="sm:col-span-2">
                ...
                <input
                  ...
                  class="w-full rounded-xl px-3 py-2 text-sm border border-slate-200 bg-white
                         ...
                         dark:border-white/10 dark:bg-neutral-900 dark:text-neutral-100 transition"
                />
              </div>
              ...
              <div class="sm:col-span-2">
                ...
                <label class="mt-1 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2
              ...
              <div
                v-if="fieldError(`detalles.${index}.cantidad`) || fieldError(`detalles.${index}.descripcion`)"
        ...
        <div class="flex items-center justify-end gap-3">
          <SecondaryButton
            type="button"
            @click="$inertia.visit(routes?.index || route('plantillas.index'))"
            class="rounded-2xl"
          >
            Cancelar
          </SecondaryButton>
